...
public class CommandImpl implements CommandInterface {
    ...
    class ToUpperTransform implements TextTransformation {
        @Override
    ...
    private class CutTransform implements TextTransformation {
    ...
    private class PasteTransform  implements TextTransformation {
    ...
    private Map<String, TextTransformation> commandTransforms;
    ...
    public void init() {
        ...
        for (Command p : this.initCommands()) {
            this.commandTransforms.putIfAbsent(p.getText(), p.getTextTransformation());
        }
    }
